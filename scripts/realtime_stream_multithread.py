...
class Avatar:
    ...
    def process_frames(self, res_frame_queue, video_len, gst_pipeline, skip_save_images):
        print(video_len)
        while True:
            ...
            if combine_frame is None:
                continue
            gst_pipeline.send_frame(combine_frame)
    ...
    def inference(self, audio_path, out_vid_name, fps, skip_save_images):
        ...
        self.idx = 0
        process_thread = threading.Thread(target=self.process_frames, args=(res_frame_queue, video_num, gst_pipeline, skip_save_images))
